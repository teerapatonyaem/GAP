    ...
    <View style={styles.modal}>
      <View style={[styles.component7, styles.parentSpaceBlock]}>
        <View style={styles.input1FlexBox}>
          ...
          <View style={[styles.tabs1, styles.tabsFlexBox]}>
            <Text style={[styles.normal, styles.activeTypo]}>สารเคมี</Text>
          </View>
          <View style={[styles.tabs1, styles.tabsFlexBox]}>
            <Text style={[styles.normal, styles.activeTypo]}>ค่าใช้จ่าย</Text>
          </View>
        </View>
            ...
            <View style={[styles.input1, styles.input1FlexBox]}>
              <View style={[styles.textfield, styles.textfieldSpaceBlock]}>
                <Image
                  ...
                  source={require("../assets/1-system-iconshome3.png")}
                />
                <Text style={[styles.text1, styles.text1Typo]}>เพิ่มเติม</Text>
              </View>
            </View>
          </View>
        </View>
        <View style={[styles.buttonParent, styles.textfieldSpaceBlock]}>
          ...
          >
            <Text style={[styles.button3, styles.buttonTypo]}>บันทึก</Text>
          </Pressable>
        </View>
      </View>
    </View>
