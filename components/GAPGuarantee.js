        ...
        <View style={styles.input1}>
          <View style={[styles.textfield, styles.textfieldBorder]}>
            <Image
              ...
              source={require("../assets/1-system-iconshome.png")}
            />
            <Text style={[styles.text1, styles.textTypo]}>1930500255741</Text>
          </View>
        </View>
      </View>
      <View style={styles.textSpaceBlock}>
...
จังหวัดปราจีนบุุรี`}</Text>
      ...
      <View style={[styles.parent, styles.textSpaceBlock]}>
        ...
        <View style={[styles.group, styles.textSpaceBlock]}>
          ...
          <View style={styles.selectionControl}>
            <View style={styles.checkboxStateLayout}>
              <View style={[styles.checkboxState, styles.checkboxStateLayout]}>
                <View style={[styles.checkboxErrorState, styles.iconLayout]}>
                  <View style={[styles.rectangle, styles.textfieldBorder]} />
                </View>
              </View>
            </View>
            <Text style={[styles.checkbox, styles.label1Typo]}>Checkbox</Text>
          </View>
        </View>
        ...
        <View style={[styles.container, styles.textSpaceBlock]}>
          <Text style={[styles.text27, styles.textTypo]}>{`ระบบการตามสอบผลิตผล 
(Traceability of Produce)`}</Text>
        ...
        <Text style={[styles.text, styles.textSpaceBlock]}>อื่นๆ โปรดระบุ</Text>
      </View>
      <View style={styles.textSpaceBlock}>
        <Text style={[styles.text26, styles.textTypo]}>
        ...
        <View style={styles.textSpaceBlock}>
          ...
          >
            ...
            <Text style={[styles.text35, styles.textTypo]}>ตำแหน่ง ประธาน</Text>
          </View>
