...
const GAPCertifyGroupname = () => {
  return (
    <View style={styles.input}>
      <View style={styles.label}>
        <Text style={[styles.label1, styles.textTypo]}>ชื่อกลุ่ม</Text>
        <Image
      ...
      <View style={styles.input1}>
        <View style={styles.textfield}>
          ...
          />
          <Text style={[styles.text, styles.textTypo]}>นาแปลงใหญ่สีเขียว</Text>
        </View>
      </View>
    </View>
  );
...
export default GAPCertifyGroupname;
