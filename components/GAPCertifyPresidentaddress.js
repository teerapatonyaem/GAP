...
const GAPCertifyPresidentaddress = () => {
  return (
    <View style={styles.input}>
      <View style={styles.label}>
        <Text style={[styles.label1, styles.textTypo]}>ที่อยู่(ประธาน)</Text>
        <Image
      ...
      <View style={styles.input1}>
        <View style={styles.textfield}>
          ...
          />
          <Text style={[styles.text, styles.textTypo]}>{`บ้านบุฝ้าย
อำเภอประจันตคาม
...
export default GAPCertifyPresidentaddress;
